...
public class EntityLivingTypeAdapter extends TypeAdapter<EntityLivingBase> {

	@Override
	public void write(JsonWriter out, EntityLivingBase entity) throws IOException {
		if (entity == null) {
			out.nullValue();
		} else {
	...
	@Override
	public EntityLivingBase read(JsonReader reader) throws IOException {
