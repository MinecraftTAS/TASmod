...
public class RequestMotionPacket implements IMessage {
	...
	public static class RequestMotionPacketHandler implements IMessageHandler<RequestMotionPacket, IMessage> {
